...
public class ComunicadosControllerView extends HttpServlet {
			...
			if (uSearch.isEmpty()) {
				...
				if (rSearch.isEmpty()) {
					...
					if (aSearch.isEmpty()) {
						...
						Comunicados comunicados = pm.getObjectById(Comunicados.class, Long.parseLong(req.getParameter("id")));
						...
						RequestDispatcher var = getServletContext()
								.getRequestDispatcher("/WEB-INF/Views/Comunicados/view.jsp");
						try {
							var.forward(req, resp);
