...
public class ComunicadosControllerDelete extends HttpServlet {
			...
			if (uSearch.isEmpty()) {
				...
				if (rSearch.isEmpty()) {
					...
					if (aSearch.isEmpty()) {
						...
						Comunicados p = pm.getObjectById(Comunicados.class, Long.parseLong(id));
						pm.deletePersistent(p);
						resp.sendRedirect("/comunicados");
					}
				}
			}
